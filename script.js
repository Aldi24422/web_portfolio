...
const translations = {
    en: {
        ...
        about_p1: "I am an Informatics Engineering graduate and a versatile Developer with 4 years of experience building end-to-end digital solutions. I specialize in integrating robust backend services with seamless cloud data management to create high-performance web and mobile applications.",
    ...
    id: {
        ...
        about_p1: "Saya adalah lulusan Teknik Informatika dan Developer serba bisa dengan 4 tahun pengalaman membangun solusi digital end-to-end. Saya berspesialisasi dalam mengintegrasikan layanan backend yang kuat dengan manajemen data cloud untuk menciptakan aplikasi berkinerja tinggi.",
