...
import 'package:animated_text_kit/animated_text_kit.dart'; // Pastikan package ini ada di pubspec.yaml

const String _fotoProfilePath = 'assets/pasfoto.png';
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      // NAMA STATIS (TANPA HOVER GELOMBANG)
                      const Text(
                        'M. Aziz Rizaldi',
                        style: TextStyle(
                          fontSize: 64,
                      ...
                      // PROFESI DENGAN EFEK TYPEWRITER
                      _TypewriterText(
                        texts: const [
                      ...
                      Row(
                        children: [
                          ...
                          _SocialBox(
                            ...
                            onPressed: () => launchUrlService(linkSkripsi),
                          ),
                        ],
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          // PROFESI MOBILE
          _TypewriterText(
            texts: const ['MOBILE APP DEVELOPER', 'SOFTWARE ENGINEER'],
...
// --- IMAGE & BUTTON WIDGETS (TETAP SAMA) ---
...
class _ProfileImageState extends State<_ProfileImage> {
  ...
  Widget build(BuildContext context) {
    Widget profileWidget = Container(
      width: widget.isMobile ? 300 : null,
      height: widget.isMobile ? 300 : double.infinity,
      decoration: BoxDecoration(
        shape: widget.isMobile ? BoxShape.circle : BoxShape.rectangle,
        color: widget.isMobile ? AppColors.offWhite : Colors.transparent,
      ...
      child: ClipRRect(
        borderRadius: BorderRadius.circular(widget.isMobile ? 200 : 0),
        child: Image.asset(
          _fotoProfilePath,
          fit: BoxFit.cover,
          alignment: Alignment.center,
    ...
    return MouseRegion(
          ...
          child: profileWidget
              ...
              .fade(begin: 1, end: 0.9, duration: 300.ms, curve: Curves.easeOut)
              .slideY(
                begin: 0.07,
                end: 0,
                duration: 300.ms,
